...
from ca_neat.patterns.patterns import ALPHABET_4, NORWEGIAN, QUIESCENT, pad_pattern
...
def replication_fitness_f_with_coord_inputs(phenotype: FeedForwardNetwork, ca_config: CAConfig) -> float:
    from ca_neat.ca.iterate import iterate_ca_n_times_or_until_cycle_found, TRANSITION_F_T
    from ca_neat.patterns.replicate_pattern import find_pattern_partial_matches
    from ca_neat.geometry.cell_grid import CellGrid2D, CellGrid
